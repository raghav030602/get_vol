...
scp raghavm@172.31.100.129:/home/maitreya/spot_fut_spread_automation/BANKNIFTY_spot.csv .
...
ln -sf `pwd`/$new_outputfileName /tmp/BANKNIFTYVol.txt
taskset -c 77 ./strategyFoSnap.out "config-FO-SNAP-Paper.txt" "strategyConfig.txt" 1>$new_outputfileName 2>$new_errorfileName
